    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="form-group {{ $errors->has('identificador') ? 'has-error' : '' }} col-12 col-md-6">
                ...
                <input type="text" id="identificador" name="identificador" class="form-control" value="{{ old('nombre', isset($periferico) ? $periferico->nombre : '') }}">
            ...
            <div class="form-group {{ $errors->has('observacion') ? 'has-error' : '' }} col-12">
                ...
                <input type="text" id="observacion" name="observacion" class="form-control" value="{{ old('nombre', isset($periferico) ? $periferico->nombre : '') }}">
            ...
            <table class=" table table-bordered table-striped table-hover  col-12" id='userTable'>
                ...
                <tbody  value=2>                   
                        ...
                        <tr data-entry-id='{{$caracteristica->id}}'>
                            ...
                            <td>
                                <!--input type='button' value='Editar' class='update btn btn-xs w-100 btn-info' data-id='id' --><input type='button' class='btn btn-xs w-100 btn-danger delete' value='Eliminar  ' data-id='id' >
                            </td>
                    </tr>;
                        @endforeach
